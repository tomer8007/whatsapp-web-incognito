...
if (document.getElementById("whatsapp-web"))
{
    ...
    UIClassNames.CHAT_PANEL_CLASS = "_amm9"; // the outermost chat panel class
    UIClassNames.INNER_CHAT_PANEL_CLASS = "_ajyl"; // the innermost chat panel class ('conversation-panel-messages')
