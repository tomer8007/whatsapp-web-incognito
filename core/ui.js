...
{
    // This part defines a list of GUI element types that the WhatsApp Web page uses.
    ...
    if (document.getElementsByClassName(newMenuItemClass).length == 0)
    {
    ...
    else
    {
        ...
        UIClassNames.UNREAD_MARKER_CLASS_3 = "xhsao0n";
